...
; Author: Ward
; Changes:	Return=1 when all ok (micha_he@autoit.de)
;			@error=3 when Source-File not Open (micha_he@autoit.de)
;			@error=4 when Destination-File not Open (micha_he@autoit.de)
; -----------------------------------------------------------------------------
